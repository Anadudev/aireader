...
const FeatureCard: React.FC<FeatureType> = ({ title, description, Icon }) => {
  return (
    <div className="flex-1 sm:min-w-[20rem] group cursor-default flex flex-col items-center gap-4 sm:gap-6 bg-blur sm:max-w-xl mx-auto p-4 sm:p-6 rounded-2xl hover:shadow-md">
